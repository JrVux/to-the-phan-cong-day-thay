...
import { CalendarRange, Clock3, LockKeyhole, RefreshCw, UsersRound } from 'lucide-react'
...
import SetupYear from './SetupYear'
...
const tabs = [
  ...
  { id: 'year', label: 'Năm mới', icon: RefreshCw, component: SetupYear },
]
...
export default function SetupIndex() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-5 gap-1 rounded-2xl bg-slate-200/70 p-1">
